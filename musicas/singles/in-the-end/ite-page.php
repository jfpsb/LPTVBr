...
<title>Singles : In The End</title>
</head>
<body>
	<?php
	...
	?>
 	...
 	<section id="main-section" class="body-section">
		<article id="ite-article" class="table-article">
			<div class="table">
				<div class="panel-header">
					<h2 class="header">In The End</h2>
				</div>
				<table class="mus-table">
					<tr>
						...
						<td id="button-td"><a class="trad-button"
							href="in-the-end.php">Tradução</a></td>
					</tr>
					<tr>
						<td>2.</td>
						<td>In The End (Live BBC Radio One)</td>
						<td id="button-td"><a class="trad-button"
							href="in-the-end-live.php">Tradução</a></td>
					</tr>
					<tr>
						<td>3.</td>
						<td>Points Of Authority (Live At Docklands Arena, London)</td>
						<td id="button-td"><a class="trad-button"
							href="points-of-authority.php">Tradução</a></td>
					</tr>
				</table>
			</div>
		</article>
