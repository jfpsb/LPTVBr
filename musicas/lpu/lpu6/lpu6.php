				...
				<table class="mus-table">
					<tr>
						...
						<td id="button-td"><a class="trad-button"
							href="/LPTVBr/musicas/lpu/lpu6/announcement.php">Tradução</a></td>
					</tr>
					<tr>
						<td>2.</td>
						<td>QWERTY (Studio DEMO Version)</td>
						<td id="button-td"><a
							href="/LPTVBr/musicas/lpu/lpu6/qwerty.php"
							class="trad-button">Tradução</a></td>
					</tr>
					<tr>
						<td>3.</td>
						<td>QWERTY (Live)</td>
						<td id="button-td"><a href="/LPTVBr/musicas/lpu/lpu6/qwerty-live.php"
							class="trad-button">Tradução</a></td>
					</tr>
					<tr>
						<td>4.</td>
						...
						<td id="button-td"><a
							href="/LPTVBr/musicas/lpu/lpu6/pushing-me-away.php"
							class="trad-button">Tradução</a></td>
					</tr>
					<tr>
						<td>5.</td>
						<td>Breaking The Habit (Live)</td>
						<td id="button-td"><a href="/LPTVBr/musicas/lpu/lpu6/breaking-the-habit.php"
							class="trad-button">Tradução</a></td>
					</tr>
					<tr>
						<td>6.</td>
						...
						<td id="button-td"><a
							href="/LPTVBr/musicas/lpu/lpu6/reading-my-eyes.php"
							class="trad-button">Tradução</a></td>
					</tr>
				</table>
			</div>
