...
<script>
	document.title = 'Singles : Numb/Encore';
</script>
</head>
<body>
	<article id="ne-article" class="table-article">
		<div class="table">
			<div class="panel-header">
				<h2 class="header">Numb/Encore</h2>
			</div>
			<table class="mus-table">
				<tr>
					<td>1.</td>
					<td>Numb/Encore</td>
					<td id="button-td"><a class="trad-button" href="numb-encore-mus">Tradução</a></td>
				</tr>
				<tr>
					<td>2.</td>
