...
<script type="text/javascript" src="/resources/js/admin/releaseCadastrar.js"></script>
</head>
<body>
	...
	<form action="<?php $_SERVER['PHP_SELF']?>" class="formulario" method="post" enctype="multipart/form-data">
		...
		<input type="text" name="urlfield"> <br>
		...
		<input type="datetime-local" name="releaselancamento" > <br>
		<label>Informe a duração (em segundos):</label>
		<input type="text" name="releaseduracao" ><br>
		<label>Informe a gravadora, se souber: </label>
		<input type="text" name="releasegravadora" > <br>
		<label>Informe as informações de copyright, se possuir: </label>
		<input type="text" name="releasecopyright" > <br>
		
		<fieldset>
			<legend>Thumbnail:</legend>
			<label>Informe a imagem: </label>
		...
		<fieldset id="grupoMusicasId" class="grupoMusicas">
			...
			<br>
			<a href="#grupoMusicasId" class="link_atualizar" onclick='populaCombobox(<?php echo json_encode($cars); ?>, true)'>Atualizar Lista</a>
			<a href="#grupoMusicasId" class="add_combobox">Adicionar Outra Música</a>
		</fieldset>
