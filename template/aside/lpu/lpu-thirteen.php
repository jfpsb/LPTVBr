<div class="album-panel">
	<img src="/LPTVBr/resources/imagens/lpu/cover250/lpu13.jpg"
		...
		href="/LPTVBr/musicas/lpu/lpu-thirteen/">Voltar ao LP Underground XIII</a>
	<ol class="album-lista">
		<li class="traducao-li"><a class="album-text"
			href="basquiat">1. Basquiat -
				2007 DEMO</a></li>
		<li class="traducao-li"><a class="album-text"
			href="holding-company">2.
		...
		<li class="traducao-li"><a class="album-text"
			href="cumulus">5. Cumulus -
				2002 DEMO</a></li>
		<li class="traducao-li"><a class="album-text"
			href="pretty-birdy">6.
				Pretty Birdy - Somewhere I Below 2002 DEMO</a></li>
		<li class="traducao-li"><a class="album-text"
			href="universe">7. Universe -
				2006 DEMO</a></li>
		<li class="traducao-li"><a class="album-text"
			href="apaches">8.
		...
		<li class="traducao-li"><a class="album-text"
			href="three-band-terror">10.
				Three Band Terror - Until It Breaks DEMO No. 3</a></li>
		<li class="traducao-li"><a class="album-text"
			href="truth-inside-a-lie">11.
