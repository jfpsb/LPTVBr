...
<link rel="stylesheet" href="/resources/css/admin/acessoConcedido.css">
			...
			<div>
				<div>
					<div id="releases" class="abas-tabView">
						<div id="tipo_pesquisa">
							<label for="tipo_release">Tipo De Release:</label> <select
								name="tipo_release">
							...
							<a href="paginasCRUD/release/releaseCadastrar.php"
								target="_blank">Cadastrar Novo Release</a>
						</div>
						<table style="width: 100%">
							...
							<tr>
								<td><label>Álbuns</label></td>
								<td><label>The Hunting Party</label></td>
								<td><label>13 de junho de 2014</label></td>
								<td><label>45:12</label></td>
								<td><a
									href="atualizarThumbnail.php?nome=teste&tamanho=small&caminho="
									title="Aperte para visualizar a thumbnail de tamanho pequeno"
									target="_blank">Small</a><br> <a
									href="atualizarThumbnail.php?nome=teste&tamanho=medium&caminho="
									title="Aperte para visualizar a thumbnail de tamanho médio">Medium</a><br>
									<a
									href="atualizarThumbnail.php?nome=teste&tamanho=large&caminho="
									title="Aperte para visualizar a thumbnail de tamanho grande">Large</a><br>
								</td>
								<td><label>Machine Shop, Warner Bros.</label></td>
								<td><label>Linkin Park Jun 17, 2014 Ⓟ Warner Bros. Records Inc.</label>
								</td>
								<td><a href="#"
									title="Aperte para atualizar os dados deste item">Atualizar</a><br>
									<a href="#" title="Aperte para remover este item">Remover</a></td>
							</tr>
						</table>
					</div>
				</div>
				<div>
					<div id="videos" class="abas-tabView">
						<div id="tipo_pesquisa">
							<label for="tipo_video">Tipo De Vídeo:</label> <select
								name="tipo_video">
							...
							<a href="paginasCRUD/video/videoCadastrar.php" target="_blank">Cadastrar
								Novo Vídeo</a>
						</div>
						<table id="tabelaVideos" style="width: 100%">
							<tr>
								<th>ID</th>
								<th>Tipo de Vídeo</th>
								<th>Nome</th>
							...
							<tr>
								<td><label>LPTV</label></td>
								<td><label>LPTV #107 | The Hunting Party Photo Shoot</label></td>
								<td><label>2014-05-08 00:00:00</label></td>
								<td><label>2999-06-13 00:00:00</label></td>
								<td><label>Unknown</label></td>
								<td><a href="#">Acessar corpo de postagem</a></td>
								<td><label><a
										href="atualizarThumbnail.php?nome=teste&tamanho=small&caminho="
										title="Aperte para visualizar a thumbnail de tamanho pequeno"
										target="_blank">Small</a><br> <a
										...
										<a
										href="atualizarThumbnail.php?nome=teste&tamanho=large&caminho="
										title="Aperte para visualizar a thumbnail de tamanho grande">Large</a><br></label>
								</td>
								<td><a href="#"
									title="Aperte para atualizar os dados deste item">Atualizar</a><br>
									<a href="#" title="Aperte para remover este item">Remover</a></td>
				...
				<div>
					<div id="musica" class="abas-tabView">
						<a id="link_cadastrar"
							href="paginasCRUD/musica/musicaCadastrar.php" target="_blank">Cadastrar
							Nova Música</a><br>
