		...
		<div class="table">
			...
			<table class="mus-table">
				<tr>
					<td>1.</td>
					<td>Faint</td>
					<td id="button-td"><a class="trad-button" href="faint-mus">Tradução</a></td>
				</tr>
				<tr>
					<td>2.</td>
					<td>Lying From You (Live)</td>
					<td id="button-td"><a class="trad-button" href="lying-from-you">Tradução</a></td>
				</tr>
			</table>
		</div>
	</article>
