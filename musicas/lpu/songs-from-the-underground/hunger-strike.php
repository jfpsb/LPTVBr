...
<body>
	<?php
	$videoId = 'g_z_WI7GZVk';
	$page_title = "Songs From The Underground : Hunger Strike (Live From Projekt Revolution 2008) - Chris	Cornell Feat. Chester Bennington (Tradução)";
	$musica = "hunger-strike";
	$nomeMusica = "Hunger Strike (Live From Projekt Revolution 2008) - Chris Cornell Feat. Chester Bennington";
	$aside = "lpu/songs-from-the-underground";
	$album = 'lpu';
