...
<script>
	document.title = "Shows : Live In Texas (Legendas)";
</script>
</head>
<body>
		<?php 
...
END;
		...
		<p class="descricao texto">Live in Texas é um álbum ao vivo gravado
				pela banda Linkin Park, este concerto foi filmado e transformado em
				DVD. O DVD foi gravado em dois concertos diferentes, em Houston e em
				Dallas, no Texas. Depois foi editado, juntando imagens dos dois. O
			...
			<p class="descricao texto">
				O download da legenda está disponível <a class="video-link"
					href="/LPTVBr/legendas/live-in-texas.srt">neste link</a>
			</p>
			<p class="descricao texto">
