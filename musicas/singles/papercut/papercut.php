...
<script>
	document.title = 'Singles : Papercut';
</script>
</head>
<body>

	<article id="papercut-article" class="table-article">
		<div class="table">
			<div class="panel-header">
				<h2 class="header">Papercut</h2>
			</div>
			<table class="mus-table">
				<tr>
					<td>1.</td>
					<td>Papercut</td>
					<td id="button-td"><a class="trad-button" href="papercut-mus">Tradução</a></td>
				</tr>
				<tr>
					<td>2.</td>
					<td>Points Of Authority (Live)</td>
				...
				<tr>
					<td>3.</td>
					<td>Papercut (Live)</td>
					<td id="button-td"><a class="trad-button" href="papercut-live">Tradução</a></td>
				</tr>
			</table>
		</div>
	</article>
