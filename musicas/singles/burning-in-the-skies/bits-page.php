...
<title>Singles : Burning In The Skies</title>
</head>
<body>
	<?php
				...
				<table class="mus-table">
					<tr>
						...
						<td id="button-td"><a class="trad-button"
							href="/LPTVBr/musicas/singles/burning-in-the-skies/burning-in-the-skies.php">Tradução</a></td>
					</tr>
					<tr>
						<td>1.</td>
						<td>Blackout (Live At Madison Square Garden)</td>
						<td id="button-td"><a class="trad-button"
							href="/LPTVBr/musicas/singles/burning-in-the-skies/blackout.php">Tradução</a></td>
					</tr>
					<tr>
						<td>1.</td>
						<td>When They Come For Me (Live At Madison Square Garden)</td>
						<td id="button-td"><a class="trad-button"
							href="/LPTVBr/musicas/singles/burning-in-the-skies/when-they-come-for-me.php">Tradução</a></td>
					</tr>
				</table>
			</div>
		</article>
