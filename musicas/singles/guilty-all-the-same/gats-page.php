...
<title>Singles : Guilty All The Same</title>
</head>
<body>
	<?php
	...
	?>
 	...
 	<section id="main-section" class="body-section">
		<article id="gats-article" class="table-article">
			<div class="table">
				<div class="panel-header">
					<h2 class="header">Guilty All The Same</h2>
				</div>
				<table class="mus-table">
					<tr>
						...
						<td id="button-td"><a class="trad-button"
							href="/LPTVBr/musicas/singles/guilty-all-the-same/guilty-all-the-same.php">Tradução</a></td>
					</tr>
				</table>
			</div>
		</article>
