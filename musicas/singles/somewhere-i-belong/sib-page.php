...
<title>Singles : Somewhere I Belong</title>
</head>
<body>
	<?php
				...
				<table class="mus-table">
					<tr>
						...
						<td id="button-td"><a class="trad-button"
							href="somewhere-i-belong.php">Tradução</a></td>
					</tr>
					<tr>
						<td>2.</td>
						<td>Step Up (Live From Projekt Revolution)</td>
						<td id="button-td"><a class="trad-button"
							href="step-up.php">Tradução</a></td>
					</tr>
					<tr>
						<td>3.</td>
						<td>My December (Live From Projekt Revolution)</td>
						<td id="button-td"><a class="trad-button"
							href="my-december.php">Tradução</a></td>
					</tr>
				</table>
			</div>
		</article>
