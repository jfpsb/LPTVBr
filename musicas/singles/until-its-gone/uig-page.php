...
<title>Singles : Until It's Gone</title>
</head>
<body>
	<?php
	...
	?>
 	...
 	<section id="main-section" class="body-section">
		<article id="uig-article" class="table-article">
			<div class="table">
				<div class="panel-header">
					<h2 class="header">Until It's Gone</h2>
				</div>
				<table class="mus-table">
					<tr>
						...
						<td id="button-td"><a class="trad-button"
							href="/LPTVBr/musicas/singles/until-its-gone/until-its-gone.php">Tradução</a></td>
					</tr>
				</table>
			</div>
		</article>
