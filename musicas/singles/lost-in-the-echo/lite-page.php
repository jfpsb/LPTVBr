...
<title>Singles : Lost In The Echo</title>
</head>
<body>
	<?php
				...
				<table class="mus-table">
					<tr>
						...
						<td id="button-td"><a class="trad-button"
							href="/LPTVBr/musicas/singles/lost-in-the-echo/lost-in-the-echo.php">Tradução</a></td>
					</tr>
					<tr>
						<td>1.</td>
						<td>Lost In The Echo (Killsonik Remix)</td>
						<td id="button-td"><a class="trad-button"
							href="/LPTVBr/musicas/singles/lost-in-the-echo/lost-in-the-echo-k-remix.php">Tradução</a></td>
					</tr>
				</table>
			</div>
		</article>
